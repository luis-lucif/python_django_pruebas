"""
URL configuration for prueba111 project.
...
from prueba111.views import hola_mundo, otra_mas, fecha_actual, vista_con_edad, vista_con_template, saludo_desde_template, index
